...
for %%F in (test_binary_unary_expr test_function_codegen test_syntax_sugar test_lua_functions test_indexed_access test_method_call test_storevar test_parser_recursion test_lexer_number test_lexer_lookahead) do (
    echo [INFO] Compiling %%F...
