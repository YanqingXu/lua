---
status: current
verified_against: docs/gc/implementation.md; docs/gc/cycle-walkthrough.md; src/gc/; src/core/gc_object.hpp; src/core/string_pool.hpp; tests/unit/gc/test_gc.cpp
