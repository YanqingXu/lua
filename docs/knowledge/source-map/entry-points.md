---
status: current
verified_against: src/main.cpp; src/bytecode/bytecode_main.cpp; tests/unit/framework/test_runner.cpp; src/repl.cpp
last_checked: 2026-07-11
applies_to: executable and library entry points
---
