---
status: current
verified_against: docs/vm/instruction-set.md; docs/vm/trace-system.md; docs/runtime/services.md; src/vm/; src/runtime/runtime_services.hpp
...
GlobalState (共享运行时资源，可由 EngineContext 拥有)
  ├── StringPool
  ├── GarbageCollector
  ├── Registry (C 代码存储)
  └── Metatables (基础类型元表)
