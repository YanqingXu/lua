---
status: current
verified_against: docs/architecture/overview.md; docs/runtime/services.md; src/core/value.hpp; src/core/value.cpp; src/core/gc_object.hpp; src/core/string_pool.hpp
