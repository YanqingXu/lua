 ...
 */
class BaseLib : public Lib::LibModule {
public:
     ...
     * Initialize module
     */
    void initialize(State* state, const Lib::LibContext& context) override;
    
    /**
     * Cleanup module resources
     */
    void cleanup(State* state, const Lib::LibContext& context) override;
 ...
 */
std::unique_ptr<Lib::LibModule> createBaseLib();
