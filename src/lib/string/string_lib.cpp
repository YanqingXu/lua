...
namespace Lua {
    ...
    void StringLib::registerFunctions(Lib::LibFuncRegistry& registry, const Lib::LibContext& context) {
        // Basic string functions with comprehensive metadata
        {
            FunctionMetadata meta("len");
            meta.withDescription("Get length of string")
                .withArgs(1, 1);
            registry.registerFunction(meta, [](State* s, i32 n) { return StringLib::len(s, n); });
        }
        
        {
            FunctionMetadata meta("sub");
            meta.withDescription("Extract substring")
                .withArgs(2, 3);
            registry.registerFunction(meta, [](State* s, i32 n) { return StringLib::sub(s, n); });
        }
        
        {
            FunctionMetadata meta("upper");
            meta.withDescription("Convert string to uppercase")
                .withArgs(1, 1);
            registry.registerFunction(meta, [](State* s, i32 n) { return StringLib::upper(s, n); });
        }
        
        {
            FunctionMetadata meta("lower");
            meta.withDescription("Convert string to lowercase")
                .withArgs(1, 1);
            registry.registerFunction(meta, [](State* s, i32 n) { return StringLib::lower(s, n); });
        }
        
        {
            FunctionMetadata meta("reverse");
            meta.withDescription("Reverse string")
                .withArgs(1, 1);
            registry.registerFunction(meta, [](State* s, i32 n) { return StringLib::reverse(s, n); });
        }
        
        // Pattern matching functions with metadata
        {
            FunctionMetadata meta("find");
            meta.withDescription("Find pattern in string")
                .withArgs(2, 4);
            registry.registerFunction(meta, [](State* s, i32 n) { return StringLib::find(s, n); });
        }
        
        {
            FunctionMetadata meta("match");
            meta.withDescription("Match pattern in string")
                .withArgs(2, 3);
            registry.registerFunction(meta, [](State* s, i32 n) { return StringLib::match(s, n); });
        }
        
        {
            FunctionMetadata meta("gmatch");
            meta.withDescription("Global pattern matching iterator")
                .withArgs(2, 2);
            registry.registerFunction(meta, [](State* s, i32 n) { return StringLib::gmatch(s, n); });
        }
        
        {
            FunctionMetadata meta("gsub");
            meta.withDescription("Global substitution")
                .withArgs(3, 4);
            registry.registerFunction(meta, [](State* s, i32 n) { return StringLib::gsub(s, n); });
        }
        
        // Formatting functions with metadata
        {
            FunctionMetadata meta("format");
            meta.withDescription("Format string with arguments")
                .withArgs(1, -1)
                .withVariadic();
            registry.registerFunction(meta, [](State* s, i32 n) { return StringLib::format(s, n); });
        }
        
        {
            FunctionMetadata meta("rep");
            meta.withDescription("Repeat string")
                .withArgs(2, 3);
            registry.registerFunction(meta, [](State* s, i32 n) { return StringLib::rep(s, n); });
        }
