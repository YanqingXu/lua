...
-- Mixed Table (both array and hash parts)
print("Testing mixed tables...")

local mixed = {10, 20, name = "mixed_table", 30}
test_assert(mixed[1] == 10, "Mixed table array part 1")
test_assert(mixed[2] == 20, "Mixed table array part 2")
test_assert(mixed[3] == 30, "Mixed table array part 3")
test_assert(mixed.name == "mixed_table", "Mixed table hash part")
...
test_assert(nested.inner.value == 42, "Nested table access (value)")
test_assert(nested.inner.name == "inner_table", "Nested table access (name)")
