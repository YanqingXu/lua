...
echo [INFO] Command: cl %CXX_FLAGS% /Isrc /c /Fo"%OUTPUT_DIR%\lexer.obj" "src\compiler\lexer.cpp"
echo.
...
if %errorlevel% neq 0 (
    echo.
    echo [ERROR] ========================================
    echo [ERROR] Lexer class compilation failed!
    echo [ERROR] Error code: %errorlevel%
    echo [ERROR] ========================================
    exit /b %errorlevel%
)
...
echo [INFO] Command: cl %CXX_FLAGS% /Isrc /c /Fo"%OUTPUT_DIR%\ast.obj" "src\compiler\ast.cpp"
echo.
...
if %errorlevel% neq 0 (
    echo.
    echo [ERROR] ========================================
    echo [ERROR] AST class compilation failed!
    echo [ERROR] Error code: %errorlevel%
    echo [ERROR] ========================================
    exit /b %errorlevel%
)
...
echo [INFO] Command: cl %CXX_FLAGS% /Isrc /c /Fo"%OUTPUT_DIR%\parser.obj" "src\compiler\parser.cpp"
echo.
...
if %errorlevel% neq 0 (
    echo.
    echo [ERROR] ========================================
    echo [ERROR] Parser class compilation failed!
    echo [ERROR] Error code: %errorlevel%
    echo [ERROR] ========================================
    exit /b %errorlevel%
)
