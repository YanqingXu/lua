...
static void testParseArgsModes(TestSuite& suite) {
...

    {
        ...
        ASSERT_TRUE(suite, opt.scriptFile != nullptr, "Script path should be recorded");
        ASSERT_TRUE(suite, std::strcmp(opt.scriptFile, "script.lua") == 0, "Script path should match");
